...
public class MainActivity extends BaseActivity {
    ...
    public MiniMusicApplication mApplication;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.like:
                Intent intent = new Intent(this, LikeMusicActivity.class);
        ...
        public Fragment getItem(int position) {
            if (position == 0) {
                ...
                if (mNetMusicFragment == null) {
                    mNetMusicFragment = mNetMusicFragment.newInstance();
                }
    ...
    protected void onDestroy() {
        ...
        SharedPreferences.Editor edit = application.mSp.edit();
        edit.putInt("currentPostion", mPlayService.getCurrentPosition());
        edit.putInt("play_mode", mPlayService.getPlay_mode());
